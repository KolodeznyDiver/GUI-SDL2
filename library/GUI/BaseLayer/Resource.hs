...
-- если и его нет, то первый же в кеше, и только если кеш пуст, будет выдано сообщение об ошибке.
--
...
--      То есть, если приложение запускается из stack проекта, то директория GUI.Resources
--      должна быть в корневой директории проекта.
--
